...
export const env = {
  ...
  BETTER_AUTH_SECRET: optionalEnv("BETTER_AUTH_SECRET", "dev-secret-change-in-production"),
  BETTER_AUTH_URL: optionalEnv("BETTER_AUTH_URL", "http://localhost:3001/api/v1/auth"),
  ...
  S3_PUBLIC_URL: optionalEnv("S3_PUBLIC_URL", "http://localhost:9000/blog-media"),
